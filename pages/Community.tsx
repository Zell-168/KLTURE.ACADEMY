        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {users.map((u) => {
              ...
              return (
                <div key={u.id} className="bg-white rounded-2xl p-6 border border-zinc-200 shadow-sm hover:shadow-md transition-shadow flex flex-col items-center text-center">
                  <div className="w-20 h-20 bg-zinc-900 text-white rounded-full flex items-center justify-center text-2xl font-bold mb-4 border-4 border-zinc-100">
                    {initials}
                  </div>
                  
                  <h3 className="text-xl font-bold text-zinc-900 mb-1">{u.full_name}</h3>
                  <p className="text-zinc-500 text-sm mb-4 line-clamp-1">{u.program || 'Member'}</p>
                  ...
                  <div className="mt-auto w-full">
                    {user ? (
                      ...
                      <Link to="/signin" className="block w-full py-2.5 rounded-xl font-bold bg-zinc-100 text-zinc-500 hover:bg-zinc-200 transition-colors">
                        Log in to Connect
                      </Link>
                    )}
                  </div>
